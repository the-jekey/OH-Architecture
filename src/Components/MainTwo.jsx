...
const MainTwo = () => {
       ...
       return (
              <div className='h-[90vh] md:h-[180vh] lg:h-[270vh] overflow-hidden  w-full bg-[#fdfdfd] shadow-md'>
                     <div className="h1 lg:text-[10vw] text-[15vw] leading-13 my-5 mb-5 md:leading-[13vw] lg:leading-[10vw] uppercase font-bold text-start px-2 ">
                            <h1>Designing  </h1>
                            <h1>homes with</h1>
                     </div>
                     <motion.div
                     ...
                     <div className="w-[95%] relative mx-auto lg:w-[45%] ">
                            ...
                            <p className=' text-[3vw] w-[90%] lg:text-2xl font-semibold'>We design spaces for people. No matter the scale
                            ...
                            <br />
                            <p className='text-[3vw] w-[90%] lg:text-2xl font-semibold'>
