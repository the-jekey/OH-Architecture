...
const Process = () => {
       return (
              <div className=' w-full py-10 h-[110vh] lg:flex overflow-hidden'>
                     ...
                     <div className="partTwo px-2 pt-20 font-semibold  lg:text-4xl lg:font-bold w-[100%]">
                            ...
                            <div className="button py-8 uppercase">
                                   <button className=' uppercase px-4 py-3 md:py-5 md:text-2xl md:px-8 bg-black text-white font-bold rounded-full'>
                                          our studio
                                   </button>
                            </div>
                     </div>
