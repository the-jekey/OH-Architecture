...
const Hero = () => {
       return (
              <div className=' w-full bg-[#fcfcfc] overflow-hidden text-black lg:py-20 px-2 font-bold  text-sm uppercase  md:text-xl lg:text-sm'>
                     <div className="naem w-full  flex justify-between items-end">
                            <div className="name w-[70%] flex items-center " >
                                   <h1 className='uppercase text-5xl lg:text-[7vw] mb-12 md:text-[10vw]'>
                                          feture <br />
                                          <p className='text-end inline-block px-15 '>product</p>
                                   </h1>

                            </div>
                            <h1 className='text-4xl md:text-[6vw] md:top-0 lg:text-[5vw] md:mb-12 lg:mr-16 '>(06)</h1>
                     ...
                     <div>
                            <div className="product w-full h-96  md:h-[65vh] lg:flex lg:justify-between">
                                   <div className="pro-1 w-[60%] h-[100%] lg:h-[30%] lg:w-[40%]">
                                          ...
                                          <div className="bottom flex justify-between items-center text-sm uppercase  md:text-xl lg:text-sm">
                                                 <h1>01</h1>
                            ...
                            <div className="product w-full flex justify-end py-[15vw] lg:items-baseline">
                                   <div className="pro-1 w-[60%] h-[100%] lg:h-[20%] lg:w-[50%]  ">
